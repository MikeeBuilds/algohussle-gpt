    ...
    <div className="flex flex-col items-center justify-center h-screen px-2  text-white">
      ...
      <div>
        ...
        <div>
            ...
            <div className="space-y-2">
                <p className="infoText">"Chnage the AlgoGPT model to use"</p>
                <p className="infoText">"Messages are stored in Forebases firestore"</p>
        ...
        <div>
            ...
            <div className="space-y-2">
                ...
                <p className="infoText">"May occasionally produce harmful instructions or biased con"</p>
                <p className="infoText">"What is the color of the sun?"</p>
            </div>
        </div>
      </div>
